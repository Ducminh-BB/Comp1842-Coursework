                                            ...
                                            (test === GER_ENG) && (
                                                <div>
                                                    ...
                                                    <div className='border border-warning border-3 rounded-2 position-relative' style={{ height: "200px"}}>
                                                        ...
                                                        <span className='position-absolute top-50 start-50 translate-middle fs-1' style={{userSelect:'none'}}>{vocab}</span>
